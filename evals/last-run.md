...
Run timestamp: 2026-04-27T04:55:52.742Z
Total elapsed: 154.3s
Total cost: $0.1730 (17.3039¢)
...
| T3 | E3 — Portfolio review (concentrated) | `claude-sonnet-4-6` | 3/3 | ✅ PASS | $0.0411 |
| T4 | E4 — Alignment delta (blocked_external + 2 prior CF) | `claude-sonnet-4-6` | 3/3 | ✅ PASS | $0.0573 |
| T5 | E5 — Manager digest (rich input) | `claude-sonnet-4-6` | 3/3 | ✅ PASS | $0.0635 |
...
- **Run 3** — ✅ (cost $0.0012)
  - raw (200 chars): ````json {   "supportingOutcomeId": "01J0SOOOO000000000000000A",   "confidence": 0.92,   "rationale": "Shipping onboarding email sequence directly targets day-7 churn reduction, the core metric of this`
